...
const wordForTheDay = targetWords[Math.floor(dayOffset)];
...
function keypress(key)
{
    ...
    {
        alert('Game Over ! See you tomorrow.');
    }
}

function danceTiles(letterElements) {
    letterElements.forEach((word, index) => {
      setTimeout(() => {
        word.classList.add("dance")
        word.addEventListener(
          "animationend",
          () => {
            word.classList.remove("dance")
          },
          { once: true }
        )
